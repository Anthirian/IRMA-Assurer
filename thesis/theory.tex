...
\begin{enumerate}
  ...
  \item \textbf{Verifiers} (also called \textbf{relying parties}) are the parties that verify a subset of the available ABCs on a card in order to authorise a transaction. An example verifier is a website that wants to verify the ABC `over 18' before it allows viewing of a certain video online.
